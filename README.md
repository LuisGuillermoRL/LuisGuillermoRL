...
* **BLOQUE 1**. En esta parte se realizaron diversos experimentos utilizando 6 CNNs: **VGG19, VGG16, ResNet50, MobileNetV2, InceptionV3 y DenseNet121**. Las imágenes utilizadas fueron tanto las masas como calcificaciones, pero la forma en que se agruparon generó distintos experimentos para atacar el problema de detección temprana del cáncer de mamá.
